package com.lqk.lib.view.pullrefresh.internal;
...
import com.lqk.lib.view.pullrefresh.PullToRefreshBase;
	...
	public LoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel, String refreshingLabel) {
		...
		switch (mode) {
			case PullToRefreshBase.MODE_PULL_UP_TO_REFRESH:
				headerImage.setImageResource(R.drawable.up);
				break;
			case PullToRefreshBase.MODE_PULL_DOWN_TO_REFRESH:
			default:
				headerImage.setImageResource(R.drawable.down);
				break;
		}
	}
